...
absenteeism data pipeline. It describes the seven pipeline artifacts, how they
fit together, and how to diagnose common problems.
...
| — | `manipulation/pipeline.md` | Docs | This document |
...
Extracts variable-level and value-level labels, then writes four codebook CSVs.
...
- Staging Parquet — `cchs_2010.parquet`, `cchs_2014.parquet`
...
- Query the staging SQLite and confirm both tables are present with expected row counts
  (~62,909 for 2010, ~63,522 for 2014).
